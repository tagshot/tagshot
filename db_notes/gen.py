...
if __name__=="__main__":
    ...
    for i in xrange(total):
        ...
        t = json.dumps({'id': i, 'exif' : {'date' : rand_word(), 'author' : rand_word(), 'model' : rand_word()},\
                        'iptc': {'stars': { 'nr': random.randint(0,5), 'of': 5 }, 'tags' : tags},\
                        'url' : "photo" + str(random.randint(1,9)) + ".jpg",\
                        ...
                        'thumb' : "photo" + str(random.randint(1,9)) + ".jpg"}, sort_keys=True)	# sort_keys=True to prevent race conditions
        if i != total-1:
